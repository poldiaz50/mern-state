...
export default function Listing() {
  ...
  return (
    <main>
      ...
      {error && <p className="text-center mt-7 text-2xl">Algo salio mal</p>}
        ...
        <div>
          ...
          <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4">
            ...
            <div className="flex gap-4">
              <p className="bg-red-900 w-full max-w-[200] text-yellow-50 text-center p-1 rounded-md">
                {listing.type === "rent" ? "Para Alquilar" : "Para Vender"}
              </p>
              {listing.offer && (
                <p className="bg-green-900 w-full max-w-[200] text-yellow-50 text-center p-1 rounded-md">
                  Descuento de: $
